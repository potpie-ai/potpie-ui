                  ...
                  <>
                    ...
                    <div className="mt-6 pt-4 border-t border-[#EBEBEB]">
                      <p className="text-[#656969] text-xs text-center">
                        ...
                        <a href="https://potpie.ai/legal/terms-of-service" className="text-[#022D2C] hover:underline">
                          Terms of Service
                        </a>{" "}
                        and{" "}
                        <a href="https://potpie.ai/legal/privacy-policy" className="text-[#022D2C] hover:underline">
                          Privacy Policy
                        </a>
                      </p>
                    </div>

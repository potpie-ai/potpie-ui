...
export default function WorkflowExecutionsPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (isDemoWorkflowId(params.workflowId)) {
        ...
        setExecutions(getDemoWorkflowExecutions(params.workflowId));
        setLoading(false);
        return;
      }
  ...
  const refreshExecutions = async () => {
    setRefreshing(true);
    try {
      const _executions = isDemoWorkflowId(params.workflowId)
        ? getDemoWorkflowExecutions(params.workflowId)
        : await WorkflowService.getWorkflowExecutions(params.workflowId);
      setExecutions(_executions);

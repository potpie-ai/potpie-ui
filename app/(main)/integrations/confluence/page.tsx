...
export default function ConfluenceIntegrationPage() {
    ...
    const handleConnect = async () => {
        ...
        try {
            console.log("🚀 Initiating Confluence OAuth flow...");

            // Step 1: Get authorization URL from backend
            const baseUrl = process.env.NEXT_PUBLIC_BASE_URL;
            const redirectUri =
                process.env.NEXT_PUBLIC_CONFLUENCE_REDIRECT_URI ||
                "http://localhost:8001/api/v1/integrations/confluence/callback";

            console.log("📡 Requesting authorization URL from backend:");
            console.log(
                "- Backend URL:",
                `${baseUrl}/api/v1/integrations/confluence/initiate`
            );
            ...
            console.log("🔗 Redirecting to Confluence authorization page...");

            // Step 2: Redirect user to Confluence authorization page
            window.location.href = data.authorization_url;
        } catch (error) {
            console.error("❌ Failed to connect Confluence integration:", error);
            const errorMessage =
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                <nav className="mb-6">
                    <ol className="flex items-center space-x-2 text-sm text-gray-600">
                        ...
                        <li className="text-gray-900 font-medium">Confluence</li>
                    </ol>
                </nav>
                ...
                <div className="mb-8">
                    <Card>
                        <CardHeader>
                            <CardTitle>About Confluence</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-sm text-gray-600 mb-4">
                                Confluence is a powerful collaboration and documentation platform
                                used by teams worldwide. This integration will help you:
                            </p>
                            <ul className="text-sm text-gray-600 space-y-2">
                                <li>• Sync documentation and pages with Confluence</li>
                                <li>• Access and search Confluence content</li>
                                <li>• Manage spaces and page hierarchies</li>
                                <li>• Collaborate on team documentation</li>
                                <li>• Organize and structure knowledge bases</li>
                                <li>• Share and manage attachments</li>
                            </ul>
                        </CardContent>
                    </Card>
                </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                ...
                                with Confluence. You&apos;ll be redirected to Atlassian to authorize
                                the integration.
                            </CardDescription>
                        </CardHeader>

...
ENV NEXT_PUBLIC_WORKFLOWS_WEBHOOK_URL=$NEXT_PUBLIC_WORKFLOWS_WEBHOOK_URL
...
ENV NEXT_PUBLIC_CONFLUENCE_REDIRECT_URI=$NEXT_PUBLIC_CONFLUENCE_REDIRECT_URI
